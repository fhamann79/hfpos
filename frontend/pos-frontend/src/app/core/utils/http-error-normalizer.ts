...
const BUSINESS_ERROR_MESSAGES: Record<string, string> = {
  ...
  SALE_VOID_REASON_REQUIRED: 'Ingresa un motivo para anular la venta.',
  SALE_VOID_REASON_TOO_LONG: 'El motivo de anulación no debe superar 500 caracteres.',
  SALE_VOID_CASH_SESSION_REQUIRED: 'Debes abrir una caja para registrar la devolución de efectivo. La venta no fue anulada.',
  SALE_VOID_CASH_INTEGRITY_INVALID: 'No se pudo determinar de forma segura el efecto de caja de esta venta. La venta no fue anulada.',
  ...
  SALE_INVOICE_AUTHORIZED_REQUIRES_CREDIT_NOTE: 'Esta factura ya fue autorizada por el SRI. No se puede anular localmente; debe emitirse una nota de crédito.',
  SALE_INVOICE_PENDING_AUTHORIZATION_NOT_VOIDABLE: 'Esta factura está pendiente de autorización SRI. Consulta el estado antes de intentar anularla.',
  SALE_INVOICE_SRI_IN_PROGRESS_NOT_VOIDABLE: 'Esta factura ya tiene proceso SRI iniciado. No se puede anular localmente hasta tener un estado final.',
  ...
  CATEGORY_INACTIVE: 'La categoría está inactiva. Actívala antes de asignar o activar el producto.',
  CATEGORY_HAS_ACTIVE_PRODUCTS: 'No se puede desactivar la categoría porque contiene productos activos.',
  CATEGORY_ALREADY_ACTIVE: 'La categoría ya está activa.',
  CATEGORY_ALREADY_INACTIVE: 'La categoría ya está inactiva.',
  PRODUCT_ALREADY_ACTIVE: 'El producto ya está activo.',
  PRODUCT_ALREADY_INACTIVE: 'El producto ya está inactivo.',
  ESTABLISHMENT_NOT_FOUND: 'El establecimiento no existe.',
  EMISSION_POINT_NOT_FOUND: 'El punto de emisión no existe.',
  ESTABLISHMENT_INACTIVE: 'El establecimiento está inactivo. Actívalo antes de continuar.',
  EMISSION_POINT_INACTIVE: 'El punto de emisión está inactivo. Actívalo antes de asignar usuarios.',
  ESTABLISHMENT_ALREADY_ACTIVE: 'El establecimiento ya está activo.',
  ESTABLISHMENT_ALREADY_INACTIVE: 'El establecimiento ya está inactivo.',
  EMISSION_POINT_ALREADY_ACTIVE: 'El punto de emisión ya está activo.',
  EMISSION_POINT_ALREADY_INACTIVE: 'El punto de emisión ya está inactivo.',
  ESTABLISHMENT_HAS_ACTIVE_EMISSION_POINTS: 'Desactiva primero los puntos de emisión activos del establecimiento.',
  ESTABLISHMENT_HAS_ACTIVE_USERS: 'Reasigna o desactiva los usuarios activos del establecimiento.',
  ESTABLISHMENT_HAS_OPEN_CASH_SESSIONS: 'Cierra las cajas abiertas del establecimiento antes de desactivarlo.',
  ESTABLISHMENT_HAS_STOCK: 'Regulariza el inventario del establecimiento hasta dejar todo el stock en cero.',
  ESTABLISHMENT_HAS_PENDING_FISCAL_DOCUMENTS: 'Resuelve las facturas y notas de crédito pendientes del establecimiento.',
  EMISSION_POINT_HAS_ACTIVE_USERS: 'Reasigna o desactiva los usuarios activos del punto de emisión.',
  EMISSION_POINT_HAS_OPEN_CASH_SESSIONS: 'Cierra las cajas abiertas del punto de emisión antes de desactivarlo.',
  EMISSION_POINT_HAS_PENDING_FISCAL_DOCUMENTS: 'Resuelve las facturas y notas de crédito pendientes del punto de emisión.',
  ...
  PRODUCT_MINIMUM_STOCK_INVALID: 'El stock mínimo debe ser mayor o igual a 0.',
  PRODUCT_COST_INVALID: 'El costo del producto debe ser mayor o igual a 0.',
  CUSTOMER_NAME_REQUIRED: 'El nombre del cliente es obligatorio.',
  CUSTOMER_NAME_TOO_LONG: 'El nombre del cliente no debe superar 150 caracteres.',
  CUSTOMER_IDENTIFICATION_TYPE_INVALID: 'Selecciona un tipo de identificación válido para el cliente.',
  CUSTOMER_IDENTIFICATION_REQUIRED: 'Ingresa el número de identificación del cliente.',
  CUSTOMER_IDENTIFICATION_INVALID: 'La identificación del cliente no es válida para el tipo seleccionado.',
  CUSTOMER_IDENTIFICATION_TOO_LONG: 'La identificación del cliente no debe superar 20 caracteres.',
  CUSTOMER_PHONE_TOO_LONG: 'El teléfono del cliente no debe superar 30 caracteres.',
  CUSTOMER_EMAIL_INVALID: 'Ingresa un email de cliente válido.',
  CUSTOMER_ADDRESS_TOO_LONG: 'La dirección del cliente no debe superar 300 caracteres.',
  CUSTOMER_NOTES_TOO_LONG: 'Las notas del cliente no deben superar 500 caracteres.',
  CUSTOMER_NOT_FOUND: 'El cliente no existe o no pertenece a esta compañía.',
  CUSTOMER_IDENTIFICATION_DUPLICATE: 'Ya existe un cliente activo con esa identificación.',
  CUSTOMER_ALREADY_INACTIVE: 'El cliente ya está inactivo.',
  CUSTOMER_ALREADY_ACTIVE: 'El cliente ya está activo.',
  CUSTOMER_FISCAL_DATA_REQUIRED: 'Completa el tipo y número de identificación del cliente para emitir factura.',
  INVALID_SRI_CUSTOMER_IDENTIFICATION: 'La identificación fiscal del comprador no es válida para factura.',
  SRI_BUYER_IDENTIFICATION_TYPE_REQUIRED: 'Selecciona un tipo de identificación SRI válido para el comprador.',
  SUPPLIER_NAME_REQUIRED: 'El nombre del proveedor es obligatorio.',
  SUPPLIER_NOT_FOUND: 'El proveedor no existe o no pertenece a esta compañía.',
  SUPPLIER_EMAIL_INVALID: 'Ingresa un email de proveedor válido.',
  SUPPLIER_IDENTIFICATION_ALREADY_EXISTS: 'Ya existe un proveedor con esa identificación.',
  PURCHASE_RECEIPT_ITEMS_REQUIRED: 'Agrega al menos un producto a la recepción.',
  PURCHASE_RECEIPT_SUPPLIER_REQUIRED: 'Selecciona un proveedor activo.',
  PURCHASE_RECEIPT_QUANTITY_INVALID: 'La cantidad recibida debe ser mayor a 0.',
  PURCHASE_RECEIPT_UNIT_COST_INVALID: 'El costo unitario debe ser mayor o igual a 0.',
  PURCHASE_RECEIPT_NOT_FOUND: 'La recepción de compra no existe.',
  ...
  CASH_SESSION_NOT_OPEN: 'La caja no está abierta.',
  CASH_SESSION_ALREADY_CLOSED: 'La caja ya está cerrada.',
  CASH_SESSION_OPENING_AMOUNT_INVALID: 'El monto inicial debe ser mayor o igual a 0.',
  CASH_SESSION_COUNTED_AMOUNT_INVALID: 'El efectivo contado debe ser mayor o igual a 0.',
  CASH_MOVEMENT_AMOUNT_INVALID: 'El monto del movimiento debe ser mayor a 0.',
  CASH_MOVEMENT_REASON_REQUIRED: 'Ingresa una razón válida para el movimiento.',
  CASH_SESSION_CONTEXT_MISMATCH: 'La caja no pertenece al contexto operativo actual.',
