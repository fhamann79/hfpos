...
public class SalesController : ControllerBase
{
    ...
    private ActionResult MapDomainError(Exception exception)
    {
        ...
        return code switch
        {
            ...
            "SALE_VOID_REASON_REQUIRED" => BadRequest(new ApiErrorResponse { Error = code }),
            "SALE_VOID_REASON_TOO_LONG" => BadRequest(new ApiErrorResponse { Error = code }),
            ...
            "SALE_VOID_CASH_SESSION_REQUIRED" => Conflict(new ApiErrorResponse { Error = code }),
            "SALE_VOID_CASH_INTEGRITY_INVALID" => Conflict(new ApiErrorResponse { Error = code }),
            "SALE_INVOICE_AUTHORIZED_REQUIRES_CREDIT_NOTE" => Conflict(new ApiErrorResponse { Error = code }),
            "SALE_INVOICE_PENDING_AUTHORIZATION_NOT_VOIDABLE" => Conflict(new ApiErrorResponse { Error = code }),
            "SALE_INVOICE_SRI_IN_PROGRESS_NOT_VOIDABLE" => Conflict(new ApiErrorResponse { Error = code }),
